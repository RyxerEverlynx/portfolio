...
function changeBg(){
    ...
    if(scrollValue < 10){
        navbar.classList.remove('changebgnav');
    } else{
        navbar.classList.add('changebgnav');
    }
}
function changeG(){
    var scrollValuegrade = window.scrollY;
    var heading = document.getElementById('nope');
    if(scrollValuegrade < 10){
...
window.addEventListener('scroll', changeG);
